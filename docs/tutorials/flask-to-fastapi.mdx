...
You can find the complete example code in our [examples repository](https://github.com/codegen-sh/graph-sitter/tree/develop/examples/examples/flask_to_fastapi_migration)
...
cd examples/examples/flask_to_fastapi_migration
python run.py
```
