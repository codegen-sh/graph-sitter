...
<Info>View the full code on [GitHub](https://github.com/codegen-sh/graph-sitter/tree/develop/examples/examples/deep_code_research)</Info>
...
@click.group()
def cli():
    """🔍 Graph-sitter Code Research CLI"""
    pass
