...
<Info>View the full code in our [examples repository](https://github.com/codegen-sh/graph-sitter/tree/develop/codegen-examples/examples/generate_training_data)</Info>
