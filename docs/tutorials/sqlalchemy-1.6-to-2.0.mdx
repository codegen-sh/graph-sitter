...
<Info>
You can find the complete example code in our [examples repository](https://github.com/codegen-sh/graph-sitter/tree/develop/examples/examples/sqlalchemy_1.4_to_2.0).
</Info>
