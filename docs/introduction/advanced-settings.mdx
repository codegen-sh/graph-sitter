...
<Note>
This flag is useful for any usages of Graph-sitter that do **NOT** require any AST/CST/Graph parsing. (i.e. using Graph-sitter purely as a file editing harness)
