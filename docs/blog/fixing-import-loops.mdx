...
<Info>
You can find the complete jupyter notebook in our [examples repository](https://github.com/codegen-sh/graph-sitter/tree/develop/codegen-examples/examples/removing_import_loops_in_pytorch).
</Info>
...
Want to try it yourself? Check out our [complete example](https://github.com/codegen-sh/graph-sitter/tree/develop/codegen-examples/examples/removing_import_loops_in_pytorch) of fixing import loops using Codegen.
