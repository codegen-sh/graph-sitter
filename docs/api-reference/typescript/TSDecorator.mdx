...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/eagarwal/update-docs2/src/graph_sitter/typescript/detached_symbols/decorator.py#L15-L54" />
