...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/eagarwal/update-docs/src/graph_sitter/typescript/statements/switch_statement.py#L18-L27" />
