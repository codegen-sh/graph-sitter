...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/eagarwal/move-examples/src/graph_sitter/typescript/expressions/named_type.py#L12-L19" />
