...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/eagarwal/update-docs2/src/graph_sitter/core/statements/try_catch_statement.py#L20-L52" />
