...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/eagarwal/update-docs2/src/graph_sitter/core/statements/if_block_statement.py#L32-L308" />
