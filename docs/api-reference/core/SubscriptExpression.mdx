...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/eagarwal/update-docs2/src/graph_sitter/core/expressions/subscript_expression.py#L24-L62" />
