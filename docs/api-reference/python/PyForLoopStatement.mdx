...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/eagarwal/move-examples/src/graph_sitter/python/statements/for_loop_statement.py#L24-L71" />
