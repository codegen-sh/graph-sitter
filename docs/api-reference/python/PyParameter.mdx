...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/eagarwal/move-examples/src/graph_sitter/python/detached_symbols/parameter.py#L11-L72" />
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/eagarwal/move-examples/src/graph_sitter/python/detached_symbols/parameter.py#L61-L72" />
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/eagarwal/move-examples/src/graph_sitter/python/detached_symbols/parameter.py#L43-L58" />
