...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/eagarwal/update-docs/src/graph_sitter/python/expressions/conditional_expression.py#L13-L20" />
...
<GithubLinkNote link="https://github.com/codegen-sh/graph-sitter/blob/eagarwal/update-docs/src/graph_sitter/core/expressions/ternary_expression.py#L35-L58" />
