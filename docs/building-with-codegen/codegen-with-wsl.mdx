...
Initial Codegen installation should be the same as the Linux instructions from the [installation guide](https://graph-sitter.com/introduction/installation).
