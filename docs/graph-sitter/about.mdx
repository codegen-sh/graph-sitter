...
Graph-sitter provides the foundational layer for code transformation: a programmatic interface for expressing complex codebase changes through code itself.

This approach creates a shared language that developers can use to:
