...
- [ ] Expand Python/Rust parity fixtures to cover full dependency semantics, imported-export chains, and mutation flows. Notes: the live fixture now exact-matches Python and TypeScript imported-export chains plus Python/TypeScript mutation outputs; broader dependency semantics remain open.
