...
- [ ] Add Rust-backed codemod mutation smoke tests for remaining graph-aware symbol/import flows. Notes: remaining parity slices should assert decorator edits, symbol-import `file.add_import`, `create_file` plus `move_to_file`, and remove flows against focused Python fixtures before trying the full codemod harness.
