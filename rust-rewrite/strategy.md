...
- [ ] Expand symbol usage extraction to full lexical shadowing behavior, attributes, module references, pattern-match bindings, comprehensions, and `global`/`nonlocal`.
