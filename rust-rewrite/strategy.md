...
- [ ] Add Rust-backed codemod mutation smoke tests for remaining graph-aware symbol/import flows. Notes: remaining parity slices should assert decorator edits, `create_file` plus `move_to_file`, and broader remove flows against focused Python fixtures before trying the full codemod harness.
...
- [ ] Add pinned large TypeScript/JavaScript compact snapshot proof. Notes: snapshot Next.js files/symbols/imports/exports with stable hashes and samples before adding TypeScript resolver/dependency parity.
