...
- [ ] Expand symbol usage extraction to full lexical shadowing behavior, attributes, module references, lambda parameters, `global`/`nonlocal`, and order-sensitive scopes.
