...
- [ ] Expand Python/Rust parity fixtures to cover full dependency semantics, imported-export chains, and mutation flows. Notes: the live fixture now exact-matches an intermediate imported-export chain and a Python/Rust mutation output; broader dependency semantics remain open.
